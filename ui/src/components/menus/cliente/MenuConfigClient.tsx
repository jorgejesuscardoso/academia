...
import { Buttons, ConfirmDeleteContainer, ConfirmPaymentContainer, Content, MenuClienteContainer, ShowDataCliente } from './styled';
...
const MenuConfigClient = ({
  ...
  const handleDeleteClient = async () => {
    ...
    Swal.fire({
      icon: 'success',
      title: 'Sucesso!',
      text: 'Cliente deletado com sucesso! Atualize a página.',
